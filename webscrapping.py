...
class WebScraper:
    def __init__(self, db: Fake_news_database, model: Fake_news_detector):
        self.db = db
        self.model = model
    ...
    def schedule_scraping(self):
        schedule.every().day.at('20:11').do(self.scrap_kompas)
        schedule.every().day.at('20:11:30').do(self.scrap_detik)
        schedule.every().day.at('20:12:00').do(self.scrap_antara)
        schedule.every().day.at('20:12:30').do(self.scrap_kominfo)
